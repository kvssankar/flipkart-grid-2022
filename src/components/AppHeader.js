  ...
  return (
    <>
      ...
      <Drawer placement={"left"} onClose={onClose} isOpen={isOpen}>
        <DrawerOverlay />
        <DrawerContent bg={useColorModeValue("gray.200", "red.800")}>
          <DrawerHeader
            borderBottomWidth={"1px"}
            display={"flex"}
            alignItems={"center"}
          >
            <Heading size={"sm"} as={Link} to={"/home"} onClick={onClose}>
              "FLIPKART ECOMMERCE GRID"
            </Heading>
            <DrawerCloseButton />
          </DrawerHeader>
          <DrawerBody p={0} bg={useColorModeValue("gray.200", "red.800")}>
